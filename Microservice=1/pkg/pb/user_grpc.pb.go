...
type UserServiceClient interface {
	...
	ListAllUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListAllUsersResponse, error)
}
...
func (c *userServiceClient) ListAllUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListAllUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	// List all users in the system.
	ListAllUsers(context.Context, *Empty) (*ListAllUsersResponse, error)
...
func (UnimplementedUserServiceServer) ListAllUsers(context.Context, *Empty) (*ListAllUsersResponse, error) {
...
func _UserService_ListAllUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ListAllUsers(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
